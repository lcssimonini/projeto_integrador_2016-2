								...
								<div class="mySlides fade">
									...
									<div class="text">
										<h1 style="font-size:300%;"><span style="color:#E27D15">MONITORE</span> SEU PROGRESSO
											<h1>
												<p>Nós sabemos que cada quilometro importa para você, por isso entregamos cada detalhe: ritmo, distância, rota e
													recordes pessoais com muita precisão e ainda mais controle sobre os dados que você deseja ver durante sua corrida.<br></p>
									</div>
								</div>
								...
								<div class="mySlides fade">
									...
									<div class="text">
										<h1 style="font-size:300%;"><span style="color:#E27D15">CORRE</span> JUNTO
											<h1>
												<p>Nunca foi tão fácil comparar e competir com seus amigos e corredores do mundo todo. Tudo que você precisa fazer
													é colocar as hashtags específicas ao compartilhar suas corridas nas redes sociais..<br></p>
									</div>
								</div>
					...
					<div class="linha meio">
						...
						<div class="col-dp-12 col-dm-12 col-dg-4 col-deg-4">
							<div id="news" class="meio-esquerdo" name="oquefazemos">
								...
								<h1>SIXFIT</h1>
								<p>
									É amplamente reconhecido que praticar atividades físicas e exercícios físicos podem trazer grandes benefícios a saúde. Entretanto,
									para se tirar o máximo destas práticas é' necessário que seja realizada uma avaliação física prévia, que permitirá
									a prescrição do exercícios com maior segurança.<br><br> O programa proposto pela Sixfit é uma avaliação
									física inicial que tem o objetivo de identificar o nível de aptidão física atual do cliente, permitindo que os exercÃ­cios
									possam ser indicados de acordo com suas necessidades e seus objetivos. Atualizações periódicas permitirão verificar
									as possíveis alterações da aptidão física, decorrentes do programa de exercícios físicos.
								</p>
								<br>
								<div class="botao"><a href="cadastro.html" title="Faça agora o seu Cadastro!">CADASTRE-SE</a></div>
								<br>
								<img align="center" src="img/quemsomos.jpg" alt="Logo" Title="SixFit - Página Inicial">
							</div>
						</div>
							...
							<div class="meio-direito">
								<div class="quadro">
									...
									<div class="col-dp-10 col-dm-8 col-dg-7 col-deg-7">
										...
										<p>
											Praticar alguma atividade física pelo menos três vezes por semana, em seu tempo livre, com duração mínima de 30 minutos é
											indicado por profissionais de saúde para pessoas de todas idades.
										</P>
								...
								<div class="quadro">
									...
									<div class="col-dp-10 col-dm-8 col-dg-7 col-deg-7">
										...
										<p>
											Os benefícios da prática de esportes para sua saúde e bem-estar são vários. Entre as mais conhecidas e esperadas são o controle
											e diminuição do peso.
										</P>
										<h2 class="escondemeio"><a href="#" title="FaÃ§a o Login">Veja os mais indicados para você.</a></h2>
									</div>
								...
								<div class="quadro">
									...
									<div class="col-dp-10 col-dm-8 col-dg-7 col-deg-7">
										...
										<p>
											Indicamos as modalidades Caminhada, Natação, Ciclismo, Patinação, Dança, Corrida e outros exercícios realizados em intensidade
											moderada, porém com a frequência cardíaca acima do nível minimo, que seja de acordo com a capacidade de cada pessoa.
										</P>
										<h2 class="escondemeio"><a href="#" title="Faça o Login">Veja os mais indicados para você.</a></h2>
									</div>
					...
					<div id="about" class="linha meio2">
						...
						<div class="col-dm-5 col-dg-3 col-deg-3 esconde">
							<div class="imgdispositivo">
								<h4>Quem somos</h4>
								<img src="img/6.jpg" alt="Logo" Title="SixFit - Página Inicial">
							</div>
						</div>

						<div class="col-dg-2 col-deg-2 esconde escondemeio">
							<div class="imgexercicio escondemeio">
								<img src="img/4.jpg" alt="Logo" Title="SixFit - Página Inicial">
								<img src="img/5.jpg" alt="Logo" Title="SixFit - Página Inicial">
							</div>
						</div>
